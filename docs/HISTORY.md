...
echo 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMbpK0BaU5Sscbe5S0chHb2dFlgExTK7LXOXLdN8HWb0 lazka' >> /etc/ssh/authorized_keys
...
echo "AuthorizedKeysFile /etc/ssh/authorized_keys .ssh/authorized_keys
